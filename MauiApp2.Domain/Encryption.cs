...
namespace MauiApp2.Domain;

public class Encryption
{
    public static async Task<Result<Info>> EncodeFileAsync(string filePath, string key, Action<int>? progressCallback = null, Action<TimeSpan>? timerCallback = null)
    {
    ...
    public static async Task<Result<Info>> DecodeFileAsync(string filePath, string key, Action<int>? progressCallback = null, Action<TimeSpan>? timerCallback = null)
    {
    ...
    private static async Task<Result> CopyDataAsync(Info info, Stream src, Stream dest, Action<int> progressCallback)
    {
        try
        {
